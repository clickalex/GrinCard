...
(function (root, factory) {
   ...
   * decide whether the page is an evaluation view rather than somebody's real card.
   * It has to mean the same thing here, or the two halves disagree: a demo link
   * would name a person whose JSON the page then cannot find. The fixtures live in
   * examples/, not profile-data/ — they moved there so a fork ships exactly one
   * obvious starter profile of its own.
   */
